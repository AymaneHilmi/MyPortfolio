...
export default function SaintGobainScreen() {
    ...
    return (
        <div className='w-full h-full flex flex-col items-center justify-center'>
            <div className=" border-b border-gray-300 w-full flex flex-row justify-center items-center mb-4 bg-[#e6e6e6]">
                <img
                    src={SaintGobain}
                    alt="Image 1"
                    className='md:h-60 h-30'
                />
            </div>
            <div className="flex flex-col w-11/12 mt-4 ">


                <a className="mt-3 text-4xl" style={{ fontFamily: 'SFBOLD', color: '#3b3d41' }}>Saint-Gobain Research Provence</a>
