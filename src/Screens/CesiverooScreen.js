...
export default function CesiverooScreen() {
    ...
    useEffect(() => {
        ...
        const frustum = 12; // taille de la vue
        let aspect = w / h;
    ...
    return (
        <div className="mx-auto max-w-6xl">
            ...
            >
                ...
                <section className="flex items-center py-16" aria-label="Wireframes — Présentation">
                    <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="order-2 lg:order-1 text-left">
                            ...
                            <p className="mt-4 text-base sm:text-lg leading-relaxed text-zinc-700 max-w-prose">
                                Définition des parcours clés, priorisation des écrans et structuration des composants
                                pour un MVP clair et rapide à itérer. Les wireframes ont servi de contrat visuel pour
                                aligner l’équipe et sécuriser les décisions produit.
                            </p>
                            <ul className="mt-6 space-y-2 text-sm text-zinc-700">
                                <li className="flex gap-3"><span className="mt-2 h-1.5 w-1.5 rounded-full bg-[#20CFBD]" /><span>Zoning et hiérarchie visuelle cohérente.</span></li>
                                <li className="flex gap-3"><span className="mt-2 h-1.5 w-1.5 rounded-full bg-[#20CFBD]" /><span>Composants réutilisables pour accélérer le dev.</span></li>
                                <li className="flex gap-3"><span className="mt-2 h-1.5 w-1.5 rounded-full bg-[#20CFBD]" /><span>Pré‑validation des interactions et bords de cas.</span></li>
                            </ul>
                        </div>
                        ...
                        <div className="order-1 lg:order-2">
                            <figure className="relative mx-auto w-full max-w-[720px] overflow-hidden rounded-2xl ring-1 ring-zinc-200 bg-white shadow-sm">
                                ...
                                <div aria-hidden className="pointer-events-none absolute -top-16 -left-16 h-40 w-40 rounded-full bg-emerald-100/50 blur-2xl" />
                                <div aria-hidden className="pointer-events-none absolute -bottom-12 -right-12 h-48 w-48 rounded-full bg-zinc-100/70 blur-2xl" />
                        ...
                        <div className="relative px-6 py-10 sm:px-12 sm:py-14">
                            ...
                            <div className="max-w-3xl">
                                ...
                                <p className="mt-3 text-base sm:text-lg leading-relaxed text-zinc-700 max-w-prose">
                                    Architecture orientée services : un front React, une gateway d’API qui centralise l’accès
                                    et des microservices Node/Express découplés. Stockage polyglotte suivant l’usage.
                                </p>
                            </div>
                            ...
                            <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div className="rounded-2xl border border-zinc-200 bg-zinc-50 p-5">
                                    ...
                                    <h3 className="mt-1 text-lg font-semibold text-zinc-900">Front React</h3>
                                    <p className="mt-2 text-sm text-zinc-600">UI, routing, state, auth tokens</p>
                                    <div className="mt-3 flex flex-wrap gap-2">
                                        {["React", "TailwindCSS", "Playwright"].map((chip) => (
                                            <span key={chip} className="inline-flex items-center rounded-full border border-zinc-200 bg-white px-2.5 py-1 text-[11px] text-zinc-700">{chip}</span>
                                        ))}
                                    </div>
                                </div>
                                <div className="rounded-2xl border border-zinc-200 bg-zinc-50 p-5">
                                    <p className="text-xs uppercase tracking-widest text-zinc-500">Edge</p>
                                    <h3 className="mt-1 text-lg font-semibold text-zinc-900">API Gateway</h3>
                                ...
                                <div className="rounded-2xl border border-zinc-200 bg-zinc-50 p-5">
                                    <p className="text-xs uppercase tracking-widest text-zinc-500">Services & Data</p>
                                    <div className="mt-2 grid grid-cols-2 gap-2 text-sm">
                                        {["Auth", "Catalogue", "Commandes", "Paiements (mock)", "Notifications", "Webhooks"].map((s) => (
                                            <div key={s} className="rounded-lg border border-zinc-200 bg-white px-3 py-2 text-zinc-700">{s}</div>
                                        ))}
                                    </div>
                                    <div className="mt-3 grid grid-cols-2 gap-2 text-sm">
                                        {["MongoDB (temps réel)", "MS SQL (reporting)"].map((db) => (
                                            <div key={db} className="rounded-lg border border-zinc-200 bg-white px-3 py-2 text-zinc-700">{db}</div>
                                        ))}
                                    </div>
                                </div>
                            </div>
