...
export default function EasterEggsScreen() {
  ...
  return (
    <div
      className={`mx-auto max-w-6xl px-4 pt-28 pb-16 space-y-10 relative ${allFound ? "animate-[pulse_4s_ease-in-out_infinite]" : ""
        }`}
    >
      {allFound ? (
        <>
              ...
              {Array.from({ length: 50 }).map((_, i) => (
                <span
                  ...
                  style={{
                    ...
                    background: ["#10b981", "#34d399", "#059669", "#6ee7b7"][
                      i % 4
                    ],
                    transform: `rotate(${Math.random() * 360}deg)`,
                    animation: `confetti-fall ${4 + Math.random() * 4
            ...
            <div className="relative flex flex-col items-start text-center">
              <div className="flex items-center gap-6 mb-8">
                <div className="relative">
                  <div className="h-24 w-24 rounded-3xl bg-gradient-to-br from-emerald-400 to-green-600 flex items-center justify-center shadow-xl">
                    <Crown className="h-12 w-12 text-white drop-shadow" />
                  </div>
                  {/* <PartyPopper className="h-7 w-7 text-emerald-500 absolute -top-2 -right-2 animate-bounce" /> */}
                </div>
              ...
              <div className="w-full max-w-3xl space-y-4">
                <div className="relative rounded-2xl border border-emerald-200/70 bg-white/80 backdrop-blur-sm p-6 shadow-inner">
                  ...
                  <p className="mt-3 text-sm leading-relaxed text-gray-600 text-left">
                    ...
                    feel free to explore other projects I’ve built on my
          ...
          <section className="mt-32 border-t border-emerald-200/60 pt-12 pb-4">
            <div className="max-w-3xl mx-auto text-center px-4">
              ...
              <p className="mt-4 text-sm text-gray-600 leading-relaxed">
                ...
                and all eggs will be hidden again.
              </p>
