...
function EggProgress() {
  ...
  return (
    <section className="relative mt-6 md:mt-16">
      <FadeIn className=" rounded-2xl border border-ultralightGray dark:border-darkBorder  shadow-sm p-6">
        <div className="flex items-center gap-4">
          <p className="text-[10px] uppercase tracking-[0.25em] text-lightPrimary dark:text-darkPrimary font-sfregular">Easter Eggs Progress</p>
        </div>
        ...
        <div className="mt-4" role="region" aria-label="Easter eggs progress">
          ...
          >
            <div
              className="h-2 rounded-full bg-brandgradient transition-[width] duration-300"
              style={{ width: `${pct}%` }}
            />
          </div>
          <p className="mt-2 text-xs text-lightPrimary dark:text-darkPrimary font-sfregular text-center">{count} / {total} found</p>
        </div>
      </FadeIn>
    </section>
  );
    ...
    <div className="lg:mx-auto max-w-5xl px-6">
        ...
        <FadeIn className="grid grid-cols-1 gap-10 md:grid-cols-2 md:gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-row gap-4 items-center">
              ...
              <span className=" font-ramidots tracking-tight text-5xl md:text-6xl lg:text-7xl bg-brandgradient bg-clip-text text-transparent w-fit pr-4">
            ...
            <div className="mt-8">
              <a
                ...
                className="inline-flex items-center gap-2 rounded-xl bg-lightPrimary dark:bg-darkContainer px-5 py-3 text-sm font-sfbold text-white shadow-md hover:shadow-lg hover:bg-brandgradient transition-colors"
      ...
      <section className="relative mt-6 overflow-hidden  ">
        <FadeIn>
          <div className="text-center">
            ...
            <h2 className="mt-2 text-4xl md:text-5xl lg:text-6xl font-ramidots tracking-tight bg-brandgradient bg-clip-text text-transparent inline-block">
              More than a resume, a living presence
            </h2>
            <span className="mt-4 block h-[3px] w-24 mx-auto rounded-full bg-brandgradient" />
          </div>

          <div className="relative text-justify mt-4">
            <p className="text-lightPrimary dark:text-darkPrimary font-sfregular/90 font-sfregular text-sm md:text-base lg:text-lg leading-relaxed">
              ...
              <LinkPreview
                ...
                url="https://agar.io"
                isStatic
                className="font-sfbold text-black dark:text-white hover:bg-brandgradient hover:bg-clip-text hover:text-transparent transition-colors duration-300"
              >
                Agar.io
              </LinkPreview>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-14 items-center ">
            <div className="order-1">
              <p className="text-[10px] text-center uppercase tracking-widest text-lightPrimary dark:text-darkPrimary font-sfregular mb-2">
                Final Version of the Portfolio
              </p>
              <div className="relative w-full rounded-2xl overflow-hidden border border-ultralightGray dark:border-darkBorder  shadow-[0_20px_60px_rgba(0,0,0,0.06)]">
                {/* Safari top bar */}
                <div className="flex items-center gap-1.5 px-2 py-1.5 bg-zinc-100/80 backdrop-blur-sm border-b border-ultralightGray">
                  <span className="h-2 w-2 rounded-full bg-red-500/80" />
                  <span className="h-2 w-2 rounded-full bg-yellow-400/80" />
                  <span className="h-2 w-2 rounded-full bg-emerald-500/80" />
                  <div className="flex-1 flex justify-center">
                    <a
                      className="inline-flex items-center gap-1.5 rounded-full  px-2.5 py-1 ring-1 ring-ultralightGray text-[10px] text-lightPrimary dark:text-darkPrimary font-sfregular shadow-sm"
                      data-cursor-icon="arrow"
                      href="https://aymanehilmi.com"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      <span className="font-sfregular text-lightSecondary">
                        https://
                      </span>
                  ...
                  <span className="hidden sm:inline-block h-2 w-6 rounded bg-ultralightGray " />
                </div>
            ...
            <div className="order-2">
              <div className="space-y-5 text-lightPrimary dark:text-darkPrimary font-sfregular text-sm md:text-base lg:text-lg leading-relaxed">
      ...
      <section className="relative mt-10 md:mt-24 ">
        <FadeIn className="">
          <div className="text-center">
            ...
            {/* <h2 className="mt-2 text-3xl md:text-6xl font-ramidots tracking-tight bg-brandgradient bg-clip-text text-transparent inline-block">
              From professional tool to creative playground
            </h2> */}
            {/* <span className="mt-4 block h-[3px] w-24 mx-auto rounded-full bg-brandgradient" /> */}

            <div className=" font-sfregular text-lightPrimary dark:text-darkPrimary text-center text-sm md:text-base lg:text-lg" >
            ...
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-8">
              {VisionsSteps.map((step, idx) => (
                <div key={idx} className="relative">
                  <article className="md:h-full overflow-hidden rounded-2xl border border-ultralightGray dark:border-darkBorder bg-bgLight dark:bg-darkContainer shadow-sm md:pl-0">
                    ...
                    <div className="p-5 space-y-3">
                      <h3 className="font-ramidots px-2 text-4xl tracking-tight bg-brandgradient bg-clip-text text-transparent inline-block ">
                        {step.title}
                      </h3>
                      <p className="text-xs uppercase tracking-widest text-lightPrimary dark:text-darkPrimary font-sfregular">
                        {step.subtitle}
                      </p>
                      <div className="flex gap-2 text-lightPrimary dark:text-darkPrimary font-sfregular">
                        {step.icons.map((icon, i) => (
                          <IconBadge key={i}>{icon}</IconBadge>
                        ))}
                      </div>
                      <p className="text-sm text-lightPrimary dark:text-darkPrimary font-sfregular leading-relaxed">
                        {step.description}
                      </p>
                    </div>
                  </article>
      ...
      <FadeIn>
        ...
        <figure className=" translate-y-6 transition will-change-transform">
          <div className="relative rounded-2xl overflow-hidden border border-ultralightGray dark:border-darkBorder shadow-[0_20px_60px_rgba(0,0,0,0.06)] maw-w-xl">
          ...
          <p className="text-[10px] uppercase tracking-[0.25em] text-lightPrimary dark:text-darkPrimary font-sfregular mt-2 ml-4">
            Ethan’s Portfolio
          </p>

          <figcaption className="mt-10 md:mt-16 ">
            <p className=" text-lightPrimary dark:text-darkPrimary font-sfregular leading-relaxed text-sm md:text-base lg:text-lg text-justify">
              One of the sites that inspired me the most was{" "}
              <a
                data-cursor-icon="arrow"
                className="font-sfbold underline"
      ...
      <section className="relative mt-16 md:mt-24">
        <FadeIn className="mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            {/* Vidéo gauche */}
            <div>
              <p className="text-[10px] uppercase tracking-[0.25em] text-lightPrimary dark:text-darkPrimary font-sfregular text-center mb-2">
                Zaid's Portfolio
              </p>
              <figure className="rounded-2xl overflow-hidden border border-ultralightGray dark:border-darkBorder shadow-[0_20px_60px_rgba(0,0,0,0.06)]">
              ...
              <figcaption className="mt-8 md:mt-10">
                <p className="text-lightPrimary dark:text-darkPrimary font-sfregular leading-relaxed max-w-3xl mx-auto text-sm md:text-base lg:text-lg text-justify">
      ...
      <section className="relative mt-6 ">
        <FadeIn className=" text-lightPrimary dark:text-darkPrimary font-sfregular space-y-4 text-sm md:text-base lg:text-lg text-justify">
          <p>
      ...
      <section className="relative">
        ...
        <FadeIn className="mt-16 relative">
          ...
          <div className="hidden md:flex justify-between items-start mx-auto">
            ...
            text-7xl font-ramidots tracking-tight bg-brandgradient bg-clip-text text-transparent w-fit mb-4"
                >
                  {step.num}
                </div>
                {/* Title */}
                <h3 className="font-sfbold text-lightPrimary dark:text-darkPrimary">{step.title}</h3>
                {/* Description */}
                <p className="mt-2 text-base text-lightPrimary dark:text-darkPrimary font-sfregular">{step.description}</p>
              </div>
            ))}
          </div>
          ...
          <div className="md:hidden space-y-10 max-w-md mx-auto">
            ...
            text-7xl font-ramidots tracking-tight bg-brandgradient bg-clip-text text-transparent w-fit "
                >
                  {step.num}
                </div>
                {/* Content */}
      ...
      <section className="mt-10 md:mt-24">
        <FadeIn className="mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12 items-start">
            ...
            <div className="flex flex-col justify-center items-center md:items-start h-full">
              ...
              <h2
                className="mt-2 text-4xl md:text-5xl lg:text-6xl font-ramidots tracking-tight 
                          bg-brandgradient bg-clip-text text-transparent inline-block">
                Navigation Flow
              </h2>
              <span
              ...
              <div className="mt-6 text-lightPrimary dark:text-darkPrimary font-sfregular leading-relaxed space-y-4 text-sm md:text-base lg:text-lg text-justify">
                <p>
          ...
          <div className="mx-auto w-full max-w-3xl select-none">
            ...
            <div className="rounded-2xl border border-ultralightGray dark:border-darkBorder bg-bgLight dark:bg-darkContainer shadow-[0_16px_50px_rgba(0,0,0,0.06)] overflow-hidden">
                  ...
                  <div className="scroll-track h-[220%]">
                    <div className="p-4 space-y-3">
                      ...
                      <div className="grid grid-cols-[7rem_1fr] gap-3">
                        <div className="col-span-2 h-80 rounded-lg bg-ultralightGray dark:bg-bgDark ring-1 ring-inset ring-ultralightGray dark:ring-darkBorder flex items-center justify-center text-lightSecondary font-sfregular">
                          Landing page
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-[7rem_1fr] gap-3">
                        ...
                        <div className="sidebar-appear sticky h-80 rounded-lg bg-ultralightGray dark:bg-bgDark ring-1 ring-inset ring-ultralightGray dark:ring-darkBorder flex items-center justify-center text-lightSecondary font-sfregular">
                          Sidebar
                        </div>
                        {/* content */}
                        <div className="h-80 rounded-lg bg-ultralightGray dark:bg-bgDark ring-1 ring-inset ring-ultralightGray dark:ring-darkBorder flex items-center justify-center text-lightSecondary font-sfregular">
                          Main Content
                        </div>
                      </div>
                    </div>
      ...
      <FadeIn className="mt-24 text-lightPrimary dark:text-darkPrimary font-sfregular leading-relaxed text-sm md:text-base lg:text-lg text-justify">
        <p>
      ...
      <section className="mt-16 md:mt-32 flex justify-center">
        ...
        <FadeIn className="grid grid-cols-[minmax(140px,200px)_1fr] sm:grid-cols-[minmax(180px,240px)_1fr] md:grid-cols-[minmax(200px,200px)_1fr] gap-6 md:gap-10 items-stretch">
          {/* SIDEBAR (mock) */}
          <div className=" border border-ultralightGray dark:border-darkBorder bg-bg-zinc-50 dark:bg-bgDark shadow-[0_24px_40px_rgba(0,0,0,0.06)]  w-full">
            <div className="grid grid-rows-[0.22fr_1fr_1fr] h-full min-w-[140px]">
              {/* Top */}
              {/* Top */}
              <div className="group relative row-span-1 p-5 sm:p-6 border-b border-ultralightGray dark:border-darkBorder flex flex-col gap-2 text-base sm:text-lg font-sfbold text-lightPrimary dark:text-darkPrimary transition-all">
              ...
              {/* Middle */}
              <div className="group relative row-span-1 border-b border-ultralightGray dark:border-darkBorder  p-5 sm:p-6 text-[13px] sm:text-sm text-lightPrimary dark:text-darkPrimary font-sfregular transition-all">
                {/* barre gradient à gauche */}
                <span className="pointer-events-none absolute left-0 top-0 h-full w-[3px] bg-gradient-to-b from-blue-500 via-orange-400 to-red-500 opacity-0 group-hover:opacity-100 scale-y-50 group-hover:scale-y-100 origin-top transition-all duration-300" />
                {/* voile subtil */}
                <span className="pointer-events-none absolute inset-0 rounded-none opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-gradient-to-r from-zinc-100/70 to-transparent dark:from-darkContainer/70  dark:to-transparent" />
                ...
                <div className="flex flex-col gap-1">
                  <h1 className="text-[10px] sm:text-xs pb-2 font-sfregular tracking-widest">
                    MOBILE APPLICATION
                  </h1>
              ...
              {/* Bottom */}
              <div className="group relative row-span-1 flex flex-col p-5 sm:p-6 text-[13px] sm:text-sm text-lightPrimary dark:text-darkPrimary font-sfregular transition-all">
                {/* barre gradient à gauche */}
                <span className="pointer-events-none absolute left-0 top-0 h-full w-[3px] bg-gradient-to-b from-blue-500 via-orange-400 to-red-500 opacity-0 group-hover:opacity-100 scale-y-50 group-hover:scale-y-100 origin-top transition-all duration-300" />
                {/* voile subtil */}
                ...
                <h1 className="text-[10px] sm:text-xs pb-2 mt-4  font-sfregular tracking-widest">
                  CONTACT
                </h1>
                <a
          ...
          <div className="flex flex-col justify-around h-full content-stretch">
            ...
            <div className="relative flex items-center pl-4 sm:pl-6">
              <div>
                <h3 className="text-base sm:text-lg md:text-xl text-lightPrimary dark:text-darkPrimary font-sfbold mb-1">
                  Personal section
                </h3>
                <p className="text-xs sm:text-sm md:text-base text-lightPrimary dark:text-darkPrimary font-sfregular">
            ...
            <div className="relative flex items-center pl-4 sm:pl-6">
              <div>
                <h3 className="text-base sm:text-lg md:text-xl font-sfbold text-lightPrimary dark:text-darkPrimary  mb-1">
                  Social section
                </h3>
                <p className="text-xs sm:text-sm md:text-base text-lightPrimary dark:text-darkPrimary font-sfregular">
      ...
      <FadeIn className="mt-16 md:mt-32 text-lightPrimary dark:text-darkPrimary font-sfregular leading-relaxed text-sm md:text-base lg:text-lg text-justify ">
        <p>
          ...
          <LinkPreview
            ...
            isStatic
            className="font-sfbold underline hover:bg-brandgradient hover:bg-clip-text hover:text-transparent transition-colors duration-300"
          >
            Spline
          </LinkPreview>
      ...
      <FadeIn>
        ...
        <figure className="translate-y-6 transition will-change-transform">
          <div className="relative rounded-2xl overflow-hidden border border-ultralightGray dark:border-darkBorder shadow-[0_20px_60px_rgba(0,0,0,0.06)] ">
          ...
          <div className="mt-10 flex flex-col items-center justify-center relative">
            ...
            <a
              ...
              rel="noopener noreferrer"
              data-cursor-icon="arrow"
              className="inline-flex items-center gap-2 rounded-xl bg-lightPrimary px-6 py-3 text-sm font-sfbold text-white shadow-md hover:shadow-lg hover:bg-brandgradient transition-colors"
            >
              View demo
            </a>
          ...
          <figcaption className="mt-10 text-center">
            <p className="mt-3 text-lightPrimary dark:text-darkPrimary font-sfregular leading-relaxed text-sm md:text-base lg:text-lg">
      ...
      <FadeIn>
        ...
        <figure className=" translate-y-6 transition will-change-transform">
          ...
          <figcaption className="mt-16 ">
            <p className="mt-3 text-lightPrimary dark:text-darkPrimary font-sfregular md:text-lg leading-relaxed"></p>
          </figcaption>
        </figure>
      </FadeIn>

      <FadeIn className="text-lightPrimary dark:text-darkPrimary font-sfregular leading-relaxed mx-auto text-sm md:text-base lg:text-lg text-justify">
              ...
              <figcaption className="mt-8 md:mt-10 ">
                <div className="mt-6 text-center">
                  <a
                    ...
                    rel="noopener noreferrer"
                    data-cursor-icon="arrow"
                    className="inline-flex items-center gap-2 rounded-xl bg-lightPrimary px-5 py-3 text-sm font-sfbold text-white shadow-md hover:shadow-lg hover:bg-brandgradient transition-colors"
                  >
                    View demo
                  </a>
                </div>
      ...
      <FadeIn className="text-lightPrimary dark:text-darkPrimary font-sfregular leading-relaxed mt-10 md:mt-16 text-sm md:text-base lg:text-lg text-justify">
      ...
      <FadeIn className="text-lightPrimary dark:text-darkPrimary font-sfregular leading-relaxed mt-8 md:mt-16 text-sm md:text-base lg:text-lg text-justify">
      ...
      <FadeIn className="text-lightPrimary dark:text-darkPrimary font-sfregular leading-relaxed mt-4 text-sm md:text-base lg:text-lg text-justify">
      ...
      <section className="relative mt-12 md:mt-24">
        <FadeIn className=" grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12 items-center">
          ...
          <figure className="order-1">
            ...
            <figcaption className="mb-3 text-[10px] text-lightPrimary dark:text-darkPrimary font-sfregular text-center uppercase">Redesign preview</figcaption>
            <div className="relative rounded-2xl overflow-hidden border border-ultralightGray dark:border-darkBorder shadow-[0_20px_60px_rgba(0,0,0,0.06)]">
          ...
          <div className="order-2 h-full flex flex-col gap-4">
            ...
            <figcaption className=" text-[10px] text-lightPrimary dark:text-darkPrimary font-sfregular text-center uppercase">Palette & Gradient</figcaption>
            <article className="rounded-2xl border border-ultralightGray dark:border-darkBorder dark:bg-darkContainer shadow-sm p-5">

              {/* Large preview bar */}
              <div className="h-12 rounded-xl ring-1 ring-ultralightGray dark:ring-darkBorder overflow-hidden">
                <div className="w-full h-full bg-brandgradient" />
              </div>
              ...
              <div className="mt-3 flex items-center gap-2">
                ...
                <button
                  ...
                  className="group relative inline-flex items-center gap-1.5 rounded-full ring-1 ring-ultralightGray dark:ring-darkBorder px-2 py-1 text-[11px]  transition 
               hover:scale-[1.02] focus:outline-none focus-visible:ring-2 focus-visible:ring-ultralightGray dark:focus-visible:ring-darkBorder"
                >
                  ...
                  <span className="relative font-sfregular text-lightPrimary dark:text-darkPrimary">#3b82f6</span>
                </button>
               ...
               hover:scale-[1.02] focus:outline-none focus-visible:ring-2 focus-visible:ring-ultralightGray dark:focus-visible:ring-darkBorder"
                >
                  ...
                  <span className="relative text-lightPrimary dark:text-darkPrimary font-sfregular">#fb923c</span>
                </button>
               ...
               hover:scale-[1.02] focus:outline-none focus-visible:ring-2 focus-visible:ring-ultralightGray dark:focus-visible:ring-darkBorder"
                >
                  ...
                  <span className="relative font-sfregular text-lightPrimary dark:text-darkPrimary">#ef4444</span>
                </button>
              </div>

              <p className="mt-4 text-sm text-lightPrimary dark:text-darkPrimary font-sfregular leading-relaxed">
            ...
            <figcaption className="text-[10px] text-lightPrimary dark:text-darkPrimary font-sfregular text-center uppercase">
              Typography
            </figcaption>
            <article className="rounded-2xl border border-ultralightGray dark:border-darkBorder dark:bg-darkContainer shadow-sm p-5">
              ...
              <div className=" grid grid-cols-1 sm:grid-cols-2 gap-4 ">
                {/* Ramidots */}
                <div className="relative rounded-xl ring-1 ring-ultralightGray dark:ring-darkBorder dark:bg-bgDark p-4 ">
                  <span className="absolute right-3 top-3 text-[10px] rounded-full px-2 py-0.5 ring-1 ring-ultralightGray dark:ring-darkBorder">Accent</span>
                  <p className="text-[10px] uppercase tracking-widest text-lightPrimary dark:text-darkPrimary font-sfregular mb-1">Display — Titles</p>
                  <h4 className="font-ramidots text-3xl md:text-4xl bg-brandgradient bg-clip-text text-transparent inline-block w-fit pr-1">
                    Ramidots
                  </h4>
                  <p className="mt-1 text-sm text-lightPrimary dark:text-darkPrimary font-sfregular leading-relaxed">
                    <span className="font-sfregular">Ramidots</span> is used for main titles and accents.
                  </p>
                </div>

                {/* SF Family */}
                <div className="rounded-xl ring-1 ring-ultralightGray dark:ring-darkBorder p-4 bg-ultralightGray dark:bg-bgDark">
                  <p className="text-[10px] uppercase tracking-widest text-lightPrimary dark:text-darkPrimary font-sfregular mb-1">Body — Interface</p>
                  <h4 className="text-2xl font-sfbold tracking-tight text-lightPrimary dark:text-darkPrimary">
                    SF Family
                  </h4>
                  <p className="mt-1 text-sm text-lightPrimary dark:text-darkPrimary font-sfregular leading-relaxed">
                    Inspired by <span className="font-sfregular">Apple’s San Francisco</span> typeface family
                  </p>
                </div>
              </div>

              <p className="mt-4 text-sm text-lightPrimary dark:text-darkPrimary font-sfregular leading-relaxed">
                The typography system balances <span className="font-sfregular">expressive identity</span> (Ramidots)
                with <span className="font-sfregular">functional readability</span> (SF family).
              </p>
            </article>

            {/* Explanatory paragraph (from your brief) */}
            {/* <div className="mt-6 text-lightPrimary dark:text-darkPrimary font-sfregular md:text-lg leading-relaxed">
              <p>
                For the new design, I wanted to add a touch of color, which is why
                <span className="mx-1 bg-brandgradient bg-clip-text text-transparent font-sfbold">this gradient</span>
                became a strong visual element throughout the site. I also introduced a new typeface called
                <span className="mx-1 font-ramidots text-2xl bg-brandgradient bg-clip-text text-transparent tracking-widest">Ramidots</span>
      ...
      <FadeIn className="relative mt-14">
        <div className="mx-auto text-justify ">
          {/* <p className="text-[10px] uppercase tracking-[0.25em] text-lightPrimary dark:text-darkPrimary font-sfregular">Navigation Update</p> */}

          <p className="mt-6 text-lightPrimary dark:text-darkPrimary font-sfregular text-sm md:text-base lg:text-lg text-justify leading-relaxed">
          ...
          <p className="mt-4 text-lightPrimary dark:text-darkPrimary font-sfregular text-sm md:text-base lg:text-lg text-justify leading-relaxed">
        ...
        <div className="relative mt-16 hidden md:grid grid-cols-3 lg:grid-cols-6 gap-8 text-center">
          ...
          <div>
            <a
              data-cursor-icon="arrow"
              className="group flex items-center justify-center h-28 rounded-xl border border-ultralightGray dark:border-darkBorder dark:bg-darkContainer  shadow-sm hover:shadow-md transition relative overflow-hidden"
            >
              <span className="absolute inset-0 bg-brandgradient opacity-0 group-hover:opacity-10 transition" />
              <span className="text-sm text-lightPrimary dark:text-darkPrimary font-sfregular group-hover:text-lightPrimary  transition">
                Link
              </span>
            </a>
            <p className="mt-2 text-xs text-lightPrimary dark:text-darkPrimary font-sfregular">External website</p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2 text-xs text-lightPrimary dark:text-darkPrimary font-sfregular">Send an email</p>
          </div>
          ...
          <div>
            <a
              ...
              className="group flex items-center justify-center h-28 rounded-xl border border-ultralightGray dark:border-darkBorder dark:bg-darkContainer  shadow-sm hover:shadow-md transition relative overflow-hidden"
            >
              <span className="text-sm text-lightPrimary dark:text-darkPrimary group-hover:text-lightPrimary font-sfregular transition">
                Copy
              </span>
            </a>
            <p className="mt-2 text-xs text-lightPrimary dark:text-darkPrimary font-sfregular">Copy to clipboard</p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2 text-xs text-lightPrimary dark:text-darkPrimary font-sfregular">Start a Video</p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2 text-xs text-lightPrimary dark:text-darkPrimary font-sfregular">Stop a Video</p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2 text-xs text-lightPrimary dark:text-darkPrimary font-sfregular">Mystery easter egg</p>
          </div>
        </div>

      </FadeIn>
      <FadeIn className="mt-16 text-lightPrimary dark:text-darkPrimary font-sfregular leading-relaxed text-sm md:text-base lg:text-lg text-justify">
      ...
      <section className="relative w-full mt-14">
        <FadeIn className="relative ">
          ...
          <div className="grid items-stretch gap-4 md:gap-6 grid-cols-1 sm:grid-cols-2 xl:grid-cols-4">
            {/* 1 — Frontend */}
            <div className="relative rounded-2xl border border-ultralightGray dark:border-darkBorder dark:bg-darkContainer p-5 shadow-sm flex flex-col h-full">
              <span className="absolute right-3 top-3 inline-flex h-6 min-w-6 items-center justify-center rounded-full bg-brandgradient text-[10px] font-sfregular text-white px-2">
                1
              </span>
              <p className="text-[10px] tracking-[0.25em] uppercase text-lightPrimary dark:text-darkPrimary font-sfregular mb-1">
                Frontend
              </p>
              <h3 className="text-2xl font-sfbold tracking-tight text-lightPrimary dark:text-darkPrimary">
                React App
              </h3>
              <ul className="mt-3 space-y-1.5 text-sm text-lightPrimary dark:text-darkPrimary font-sfregular">
                <li>Vite (bundler)</li>
                <li>TailwindCSS</li>
              </ul>
              <div className="mt-auto pt-4">
                <span className="block h-1 w-16 rounded-full bg-brandgradient" />
              </div>
            </div>
      ...
      <FadeIn className="mt-12 md:mt-24 text-lightPrimary dark:text-darkPrimary font-sfregular leading-relaxed text-sm md:text-base lg:text-lg text-justify">
      ...
      <section className="relative mt-6">
        <FadeIn className=" gap-10 md:gap-12 items-start">
          <div className="space-y-4">
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-ramidots tracking-tight bg-brandgradient bg-clip-text text-transparent inline-block">
              Easter Eggs Quest
            </h2>
            <span className="block h-[3px] w-24 rounded-full bg-brandgradient" />
      ...
      <FadeIn className="flex flex-col justify-center items-center mt-6 md:mt-14  ">
        ...
        <div className="">
          <p className="mt-4 text-lightPrimary dark:text-darkPrimary font-sfregular leading-relaxed text-sm md:text-base lg:text-lg text-justify">
            ...
            <a href="https://github.com/AymaneHilmi/MyPortfolio" target="_blank" className="underline font-sfbold hover:bg-brandgradient hover:bg-clip-text hover:text-transparent transition-colors duration-300" data-cursor-icon="arrow">
              clicking here
            </a>.
          </p>
          ...
          {/* <div className="mt-8 flex flex-row items-center justify-center gap-4">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center gap-2 rounded-full border border-ultralightGray dark:border-darkBorder px-6 py-3 text-sm font-sfregular text-lightPrimary dark:text-darkPrimary font-sfregular shadow-sm hover:shadow-md hover:border-zinc-300 transition"
...
function IconBadge({ children }) {
  return (
    <span className="inline-flex items-center justify-center h-8 w-8 rounded-full border border-ultralightGray dark:border-darkBorder  shadow-sm">
      {children}
    </span>
  );
}
...
function StackVisual({ variant }) {
  return (
    <FadeIn className="absolute inset-0  group">
      {/* stack container */}
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[78%] max-w-sm h-[78%]">
        {/* sheet 3 (back) */}
        <div className="absolute inset-0 translate-x-[-10px] translate-y-[10px] rounded-xl bg-bgLight dark:bg-bgDark border border-ultralightGray dark:border-darkBorder shadow-sm transition-transform duration-300 group-hover:-rotate-6 group-hover:-translate-x-3 group-hover:translate-y-3" />
        {/* sheet 2 */}
        <div className="absolute inset-0 translate-x-[-6px] translate-y-[6px] rounded-xl bg-bgLight dark:bg-bgDark border border-ultralightGray dark:border-darkBorder shadow-sm transition-transform duration-300 group-hover:-rotate-3 group-hover:-translate-x-1.5 group-hover:translate-y-1.5" />
        {/* sheet 1 (top) */}
        <div className="absolute inset-0 rounded-xl bg-bgLight dark:bg-bgDark border border-ultralightGray dark:border-darkBorder shadow-sm overflow-hidden transition-transform duration-300 group-hover:scale-[1.02]">
          {/* inner content by variant */}
          {variant === "cv" && (
            <div className="p-4 space-y-2">
              <div className="h-3 w-24 rounded bg-ultralightGray dark:bg-darkContainer" />
              <div className="h-2 w-40 rounded bg-ultralightGray dark:bg-darkContainer" />
              <div className="h-2 w-36 rounded bg-ultralightGray dark:bg-darkContainer" />
              <div className="mt-2 space-y-1.5">
                <div className="h-2 w-48 rounded bg-ultralightGray dark:bg-darkContainer" />
                <div className="h-2 w-44 rounded bg-ultralightGray dark:bg-darkContainer" />
                <div className="h-2 w-40 rounded bg-ultralightGray dark:bg-darkContainer" />
              </div>
              <div className="mt-2 space-y-1.5">
                <div className="h-2 w-48 rounded bg-ultralightGray dark:bg-darkContainer" />
          ...
          {variant === "image" && (
            <div className="h-full w-full p-4">
              <div className="grid h-full w-full grid-cols-3 grid-rows-3 gap-3">
                {/* Big hero tile */}
                <div className="col-span-2 row-span-2 rounded-lg bg-ultralightGray dark:bg-darkContainer ring-1 ring-inset ring-ultralightGray dark:ring-darkBorder overflow-hidden transition-transform duration-300 group-hover:scale-[1.02]">
                  <div className="h-full w-full grid place-items-center">
                    <Image
                      className="h-10 w-10 text-lightSecondary font-sfregular transition-transform duration-300 group-hover:rotate-3 group-hover:scale-110"
                      strokeWidth={1}
                    />
                  </div>
                </div>
                {/* Small square */}
                <div className="col-span-1 row-span-1 rounded-lg bg-ultralightGray dark:bg-darkContainer ring-1 ring-inset ring-ultralightGray dark:ring-darkBorder grid place-items-center transition-transform duration-300 group-hover:-rotate-1">
                  {/* <Image className="h-6 w-6 text-lightSecondary font-sfregular" strokeWidth={1} /> */}
                </div>
                {/* Tall tile with caption bars */}
                <div className="col-span-1 row-span-2 rounded-lg bg-ultralightGray dark:bg-darkContainer ring-1 ring-inset ring-ultralightGray dark:ring-darkBorder p-3 flex flex-col justify-between transition-transform duration-300 group-hover:translate-y-0.5">
                  <div className="space-y-2">
                    <div className="h-2 w-full rounded bg-ultralightGray dark:bg-bgDark" />
                    <div className="h-2 w-full rounded bg-ultralightGray dark:bg-bgDark" />
                    <div className="h-2 w-full rounded bg-ultralightGray dark:bg-bgDark" />
                    <div className="h-2 w-full rounded bg-ultralightGray dark:bg-bgDark" />
                    <div className="h-2 w-full rounded bg-ultralightGray dark:bg-bgDark" />
                ...
                {/* Wide caption strip */}
                <div className="col-span-2 row-span-1 rounded-lg bg-ultralightGray dark:bg-darkContainer ring-1 ring-inset ring-ultralightGray dark:ring-darkBorder p-3 flex items-center gap-3 transition-transform duration-300 group-hover:translate-x-0.5">
                  <div className="flex-1 space-y-2">
                    <div className="h-2 w-full rounded bg-ultralightGray dark:bg-bgDark" />
                    <div className="h-2 w-3/5 rounded bg-ultralightGray dark:bg-bgDark" />
                  </div>
                </div>
              </div>
            </div>
          ...
          {variant === "image3d" && (
            <div className="relative h-full w-full">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="grid place-items-center rounded-lg ring-1 ring-inset ring-ultralightGray dark:ring-darkBorder bg-bgLight dark:bg-darkContainer w-[78%] h-[64%]">
                  <div className="flex items-center gap-2 text-lightPrimary dark:text-darkPrimary font-sfregular">
                    <Boxes
                      className="h-10 w-10 text-lightSecondary font-sfregular transition-transform duration-500 group-hover:rotate-12 group-hover:scale-110"
                      strokeWidth={1}
                    />
                  </div>
                </div>
