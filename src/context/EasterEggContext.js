...
const EggList = [
  {
    ...
    message:
      "Confetti egg Founded. \n\n But i think you can do better, it's the easiest one",
    level: "Easy",
    cursor: "egg#1",
  },
  {
  ...
  },
  {
    ...
    message: "You uncovered the secret beneath the surface!",
    level: "Medium",
    cursor: "egg#4",
  },
  {
...
export const EasterEggProvider = ({ children }) => {
    ...
    /* ====== API Missions ====== */
    const isMissionCompleted = (missionId) => completedMissions.includes(missionId);
