...
const getBadgeStyle = (level) => {
  switch (level) {
    ...
    case "Ultimate":
      return "bg-cyan-500 text-white shadow-[0_0_8px_rgba(6,182,212,0.9)]";
    default:
  ...
  return (
    <div>
      ...
      <p className="text-sm text-gray-500 mb-6 italic">
        Welcome to the Egg Chamber! Here you can track your progress in finding
        all the hidden easter eggs. May the eggs be ever in your favor!
      </p>
      ...
      <div className="mb-6">
        <div className="flex justify-between text-sm text-gray-600 mb-1">
          <span>Progress</span>
          <span>
            {foundEggs.length} / {total} eggs found
          </span>
        </div>
              ...
              <div className="flex items-start justify-between relative z-10">
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    <span
                      className={`text-xs px-2 py-0.5 rounded-full font-medium ${getBadgeStyle(
                        egg.level
                      )}`}
                    >
                      {egg.level}
