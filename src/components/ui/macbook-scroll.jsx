...
export const MacbookScroll = ({
  ...
  const stopAt = isMobile ? 680 : 980;
  const translate = useTransform(scrollYProgress, [0, 0.6, 1], [0, stopAt, stopAt]);
  ...
  return (
    <div
      ref={ref}
      className="flex h-[200vh] md:h-[250vh] shrink-0 scale-[0.35] transform flex-col items-center justify-start py-0 [perspective:800px] sm:scale-50 md:scale-100 md:py-80">
      <motion.h2
        style={{
          translateY: textTransform,
          opacity: textOpacity,
        }}
        className="mb-20 text-left text-xl font-sfregular text-neutral-800 ">
        {title || (
          <span>
...
const Logo = () => {
  return (
    <span className="text-4xl font-InkBrushArabic bg-gradient-to-r from-blue-500 via-orange-400 to-red-500 bg-clip-text text-transparent">
              Aymane's Macbook 
            </span>
  );
};
