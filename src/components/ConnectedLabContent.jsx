...
export default function ConnectedLabContent() {
    ...
    return (
        <div className="lg:mx-auto max-w-5xl px-6 text-sm lg:text-base font-sfregular overflow-hidden md:overflow-visible">
            ...
            {/* About section */}
            <FadeIn className="mx-auto py-8 md:py-12 flex justify-center items-center">
            ...
            <FadeIn id="sm-process-diagram" className="my-8 text-justify">
            ...
            <FadeIn className="my-10 md:my-14">
            ...
            {/* Before / After grid */}
            <FadeIn className="my-12 md:my-16">
    ...
    backdrop-blur-lg p-5 md:p-6 hover:shadow-[0_20px_70px_rgba(59,130,246,0.35)] dark:hover:shadow-[0_20px_70px_rgba(59,130,246,0.25)] overflow-hidden duration-300">
        ...
        text-lightSecondary dark:text-darkSecondary">
            ...
            <FadeIn className="relative w-full flex justify-center my-4">
        ...
        flex items-center justify-center text-white text-xs font-sfbold flex-shrink-0">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 my-4 md:ml-8">
                                ...
                                <div className="rounded-xl border border-ultralightGray dark:border-darkPrimary border-dashed p-3 opacity-60">
            ...
            {/* Interactive tree */}
            <FadeIn className="flex flex-col md:flex-row w-full gap-8">
            ...
            <FadeIn className="list-decimal list-inside mt-2 space-y-1 ">
                ...
                <AnimatedBeamMultipleOutputDemo className="py-4" />
            ...
            <FadeIn className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mt-8 mb-12">
